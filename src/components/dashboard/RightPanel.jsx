...
export default function RightPanel() {
  ...
  return (
    <div className='min-h-[calc(100vh-64px)] p-6 lg:col-span-8'>
      {!activeJob && <Message text='Select a job to view details' />}
        ...
        Get AI Analysis
          ...
          <div className='mt-6'>
            ...
            <p className='text-paragraph lg:max-w-3xl lg:text-lg'>
              We are looking for an experienced Senior React Developer to lead
              our frontend architecture. You will be responsible for building
              highly performant, scalable web applications and mentoring junior
              developers.
            </p>
          </div>
          <div className='mt-6'>
