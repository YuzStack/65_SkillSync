  ...
  return (
    <section className='container mx-auto mt-6 flex items-center justify-center bg-[url(/bg-decorative-element-bg-circuitry.png)] bg-contain bg-center py-4 lg:py-6'>
      <div className='flex flex-col items-center gap-4 p-4 lg:gap-6 lg:p-6'>
        ...
        <Link to='/dashboard'>
          <button className='bg-theme hover:bg-theme/90 shadow-theme my-2.5 rounded-lg p-2 px-2.5 font-semibold text-black shadow transition-all hover:scale-105 lg:my-5 lg:px-4 lg:py-3 lg:text-lg'>
            Launch Application
          </button>
        </Link>
